...
public class PlayerController implements Initializable {
    ...
    private void handleReady() {
        ...
        //String decimal = duration.toString();
        lengthText.setText(String.format("%.7s", duration));
    ...
    private void handleUpdate(double timestamp, double duration, float[] magnitudes, float[] phases) {
        ...
        currentText.setText(String.format("%.7s", ms));
    ...
    @FXML
    private void handleDragRelease(Event event) {
        if (mediaPlayer != null) {
            double duration = timeSlider.getValue();
